...
addBtn.addEventListener("click", function () {
  const html = `<div class="pre box-${count}">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class = "delete-element">
  ...
  pres.insertAdjacentHTML("beforeend", html);
  count++;
  dltele = document.getElementsByClassName("delete-element");
});
